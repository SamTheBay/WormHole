...
namespace TunnelDecent
{
    ...
    static class Fonts
    {
        ...
        public static void LoadContent(ContentManager contentManager)
        {
            ...
            playerStatisticsFont = contentManager.Load<SpriteFont>("Fonts/PlayerStatisticsFont");
        }
        ...
        {
            DrawCenteredText(spriteBatch, font, text, position, color, 1f);
        }

        public static void DrawCenteredText(SpriteBatch spriteBatch, SpriteFont font,
            string text, Vector2 position, Color color, float scale)
        {
            // check the parameters
            if (spriteBatch == null)
            {
            ...
            spriteBatch.DrawString(font, text, centeredPosition, color, 0f,
                Vector2.Zero, scale, SpriteEffects.None, 1f - position.Y / 720f);
        }
