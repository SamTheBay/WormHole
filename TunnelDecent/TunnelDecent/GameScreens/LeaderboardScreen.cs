...
namespace TunnelDecent
{
    ...
    class LeaderboardScreen : MenuScreen
    {
        ...
        {
            string cypher = Encryption64.Encrypt("WormHole+addNewScore+" + sendName + "+" + GameplayScreen.player.Points.ToString(), "q{Fe%xR:q{Fe%xR:");
            webRequest = (HttpWebRequest)WebRequest.CreateHttp(new Uri("http://69.67.29.80:8080/WormHole?id=" + cypher, UriKind.Absolute));
