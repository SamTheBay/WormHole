    ...
    public class AdControlManager
    {
        ...
        public AdControlManager(GameComponentCollection Components, bool testMode = true)
        {
            ...
            if (adType == AdControlType.MSFT)
            {
                if (testMode)
                {
                    AdGameComponent.Initialize(TunnelGame.sigletonGame, "test_client");
                }
                else
                {
                    AdGameComponent.Initialize(TunnelGame.sigletonGame, "3eda0b84-f8cb-467a-af98-5062872c0ef7");
                }
        ...
        public void Load()
        {
            ...
            if (adType == AdControlType.MSFT)
            {
                if (testMode)
                {
                    bannerAd = AdGameComponent.Current.CreateAd(testAdUnit, new Rectangle(0, 720, 480, 80), false);
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        bannerAd = AdGameComponent.Current.CreateAd(mainAdUnit, new Rectangle(0, 720, 480, 80), false);
                    }
                }
            ...
            {
                adView = new MMAdView(TunnelGame.graphics.GraphicsDevice, new Vector2(0, 720), AdPlacement.BannerAdTop);
                adView.Apid = "60242";
            ...
            {
                adDuplex = new AdManager(TunnelGame.sigletonGame, "9831");
                adDuplex.LoadContent();
                adDuplex.RefreshInterval = 30;
            }
#endif

            defaultAd = TunnelGame.sigletonGame.Content.Load<Texture2D>("Textures/DefaultAd");
        }
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (adType == AdControlType.MSFT)
            {
                ...
                bannerAd.DisplayRectangle = new Rectangle(0, 720, 480, 80);
        ...
        public void Draw(GameTime gameTime)
        {
            ...
            if (showAds)
            {
                ...
                SpriteBatch spriteBatch = TunnelGame.screenManager.SpriteBatch;

                spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.AlphaBlend);

                spriteBatch.Draw(defaultAd, new Vector2(0,720), Color.White);
                ...
                {
                    adDuplex.Draw(spriteBatch, new Vector2(0, 720));
                }
            }
#endif
        }
