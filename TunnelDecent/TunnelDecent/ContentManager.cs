...
namespace TunnelDecent
{
    ...
    class InternalContentManager
    {
        ...
        static public void Load()
        {
            ...
            LoadContentHolder("Ship", "ship");
            LoadContentHolder("Gradient", "gradient");
            LoadContentHolder("vgradient", "vgradient");
        ...
        static private void LoadContentHolder(string name, string textureLocation)
        {
            ...
            holder.Texture = TunnelGame.sigletonGame.Content.Load<Texture2D>(System.IO.Path.Combine(@"Textures", textureLocation));
